...
const partTimeNum = ref();
const name = ref('XXX');
const departmentName = ref(sessionStorage['loginOrganizationName']);
...
const dateTime = ref('');
const dateValue0 = ref('');
const timeValue0 = ref('');
const timeValue = ref('');
const address = ref('');
const messageTemplate = ref('');

const handleChangeTime = () => {
  // ... 在这里处理 handleChangeTime 逻辑 ...
};

const dateTimeValue = () => {
  // ... 在这里处理 dateTimeValue 逻辑 ...
};
